...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    owner = "HearseDev";
    repo = "wezterm";
    rev = "75116541bb2ebeb0286364a69a8738494e2d13ef";
    fetchSubmodules = true;
    hash = "sha256-X5KINn27OUOH3hEDXt32FarNsrnpvnFU/TfNyVGjqc4=";
  };
  ...
  cargoHash = "sha256-p+gMz3BQyOH2UyWZZ2vXlRQdfFvfh5K138/lPTZtSyM=";
